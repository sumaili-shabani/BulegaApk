...
export default {
  ...
  methods: {
    ...
    showModal() {
      this.dialog = true;
      this.titleComponent = "Ajout un Mot de la semaine ";
      this.edit = false;
    ...
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_week?page=`);
    },
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_week/${id}`).then(
        ({ data }) => {
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_week/${id}`).then(
          ({ data }) => {
