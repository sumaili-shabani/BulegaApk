          ...
          <v-card-text>
            <v-simple-table>
              <template v-slot:default>
                <thead>
                  <tr>
                    <th class="text-left">Nom du secteur d'activité</th>
...
export default {
  ...
  methods: {
    ...
    showModal() {
      this.dialog = true;
      this.titleComponent = "Ajout secteur d'activité ";
      this.edit = false;
    ...
    testTitle() {
      if (this.edit == true) {
        this.titleComponent = "modification de secteur d'activité " + item.nomSecteur;
      } else {
        this.titleComponent = "Ajout secteur d'activité ";
      }
    },
    ...
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_secteur?page=`);
    },
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/insert_secteur`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_secteur/${id}`).then(
        ({ data }) => {
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_secteur/${id}`).then(
          ({ data }) => {
