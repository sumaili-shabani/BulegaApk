<template>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Ajout une Catégorie ";
        this.edit = false;
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_category_article?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_category_article`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_category_article/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_category_article/${id}`).then(
            ({ data }) => {
